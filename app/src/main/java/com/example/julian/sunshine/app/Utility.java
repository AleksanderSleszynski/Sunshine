...
public class Utility {
    // we'll default out latlong to 0. Yay, Earth!
    ...
    public static float getLocationLongtitude(Context context){
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
     ...
     */
    public static String getFriendlyDayString(Context context, long dateInMillis, boolean displayTodayLong) {
        ...
        // is "Today, June 24"
        if (displayTodayLong && julianDay == currentJulianDay) {
