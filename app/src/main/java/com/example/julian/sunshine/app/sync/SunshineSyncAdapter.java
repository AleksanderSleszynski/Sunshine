package com.example.julian.sunshine.app.sync;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        String locationLongitude = String.valueOf(Utility.getLocationLongtitude(context));
        ...
        try {
            ...
            String keyId = "4f8e2ef67ca8a262e244ea9776ff8336";
            ...
            if(Utility.isLocationLatLongAvailable(context)){
                uriBuilder.appendQueryParameter(LAT_PARAM, locationLatitude)
                        .appendQueryParameter(LONG_PARAM, locationLongitude);
            } else {
            ...
            Uri builtUri = uriBuilder.appendQueryParameter(FORMAT_PARAM, format)
                    ...
                    .appendQueryParameter(APPID_PARAM, keyId)
                    .build();
